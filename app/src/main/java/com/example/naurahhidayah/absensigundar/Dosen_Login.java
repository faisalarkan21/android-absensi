...
public class Dosen_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dosen__login);
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Dosen_Login.this, WelcomeActivity.class));
                finish();
            }
        });
        ...
        progressDialog = new ProgressDialog(Dosen_Login.this);
    ...
    public void sendPost(String email, String password) {
        ...
        response.enqueue(new Callback<ResponseBody>() {
                    ...
                    try {
                        ...
                        new CountDownTimer(1000, 1000) {
                            ...
                            public void onFinish() {
                                ...
                                Intent dashboard = new Intent(Dosen_Login.this, DosenMain.class);
            ...
            public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                ...
                Toast.makeText(Dosen_Login.this, throwable.getMessage(),
                        Toast.LENGTH_LONG).show();
            }
        });
