...
public class AdapterLogInListPertemuanDosenMhs extends RecyclerView.Adapter<AdapterLogInListPertemuanDosenMhs.MyViewHolder> {
    ...
    public AdapterLogInListPertemuanDosenMhs(Activity activity, List<Mahasiswa> mhsItems) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        if (m.getNama().equals("Tidak Ada Data")){
